...
export default class SetAtt extends Component {
    ...
    onSendClick(){
        ...
        var tosend = {
            "my_port":Number(this.state.my_port),
            "dest_ip":this.state.dest_ip,
            "dest_port":Number(this.state.dest_port),
            "key_path": this.state.key_path
        }
            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <div className='col-12 col-md-4'>
                        ...
                        <Link to={"/chat"}><button className='button1' onClick={()=>this.onSendClick()}>{this.state.loading ? <div class="lds-dual-ring"></div> : "start"}</button></Link>
                    </div>
                    <div className='d-none d-md-block col-md-4 d-flex justify-content-center'>
